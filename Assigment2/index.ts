...
let favoritemovie:string = "Mission Impossible && Fast and Furious";
console.log(favoritemovie);

//Q2
//•	Create a template string to introduce yourself, including your name and age.
let fullname:string = "Shahzad Akbar";
let age:number = 27;
...
let firstname:string = "Shahzad";
let lastname:string = "Akbar";
console.log(`My Firstname is ${firstname} and the lastname is ${lastname}`)
